...
- Utilizar la rejilla opcional del shader opaco de producción sobre los modelos convertidos. Comparar ausencia de rejilla, líneas y juntas biseladas mediante normales y rugosidad; evaluar después parallax, AO de juntas y variación de altura por SurfaceID. Comprobar estabilidad temporal y continuidad entre chunks, LODs y transformaciones antes de ampliar el acabado.
