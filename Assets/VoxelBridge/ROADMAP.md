...
| Geometría limpia y detalle separado | Rejilla opcional, POM y hundimientos por SurfaceID. Variantes experimentales con profundidad y relieve en sombras; laboratorio SPOM de bloque y copia SPOM de una familia LOD0 con ocupación y atributos compartidos entre chunks. Pendientes: LODs y multiescala de SPOM, AO, validación artística y temporal, colocación estática, Entities Graphics, anuncios y mediciones. |
