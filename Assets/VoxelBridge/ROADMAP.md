...
| Geometría limpia y detalle separado | Rejilla opcional de normales y rugosidad con perfiles de líneas o juntas biseladas, modos fijo y multiescala binaria, anclaje mundial o de familia y validador de su marco local. El bisel no modifica geometría ni profundidad. Pendientes: evaluación de parallax, variación por SurfaceID, validación artística y temporal, colocación estática, integración con Entities Graphics, anuncios sobre quads y mediciones. |
