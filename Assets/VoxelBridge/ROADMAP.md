...
- Previsualización con el shader semántico y perímetro de las regiones coplanares seleccionadas, sin cuadrícula y con oclusión por profundidad. `Tint` permite activar o desactivar un tinte suave sin cambiar las asignaciones. Los huecos, grupos separados y cambios de plano conservan sus contornos. La vista de diagnóstico por SurfaceID permanece pendiente para distinguir superficies con apariencia similar sin modificar la paleta de color.
