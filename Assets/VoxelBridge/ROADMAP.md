...
| Geometría limpia y detalle separado | Rejilla opcional de normales y rugosidad en el shader opaco de producción; modos fijo y multiescala binaria, anclaje mundial o de familia y validador de su marco local. Pendientes: acabado avanzado, validación artística y temporal, colocación estática, integración con Entities Graphics, anuncios sobre quads y mediciones. |
