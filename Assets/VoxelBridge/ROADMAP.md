...
| Geometría limpia y detalle separado | Rejilla opcional de normales y rugosidad, POM cercano y hundimientos por SurfaceID; anclaje mundial o local y escala visual fija o multiescala. Variante experimental con profundidad y relieve en sombras. Laboratorio SPOM de bloque cerrado con silueta y laterales; no aplicable directamente a edificios. Pendientes: ocupación y límites para SPOM en chunks, AO, intersecciones, validación artística y temporal, colocación estática, Entities Graphics, anuncios y mediciones. |
