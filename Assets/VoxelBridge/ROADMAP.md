...
| Geometría limpia y detalle separado | Rejilla opcional de normales y rugosidad con perfiles de líneas o juntas biseladas y ensayo de POM procedural cercano; modos fijo y multiescala binaria, anclaje mundial o de familia y validador de su marco local. No modifica geometría ni buffer de profundidad. Pendientes: offset de profundidad y SPOM, variación por SurfaceID, validación artística y temporal, colocación estática, integración con Entities Graphics, anuncios sobre quads y mediciones. |
