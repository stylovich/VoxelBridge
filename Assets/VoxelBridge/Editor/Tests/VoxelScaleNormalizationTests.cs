...
namespace LocalModels.VoxelBridge.Tests
{
    public sealed class VoxelScaleNormalizationTests
    {
        ...
        [Test]
        public void Normalize_RejectsReflectionAndShear()
        {
        ...
        [Test]
        public void Batch_NormalizationSeparatesScaledSourcesAndInvalidatesEstimates()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    ...
                    instance.transform.localScale = Vector3.one * (i + 1);
                }
        ...
        [Test]
        public void NormalizedBatch_PreservesSizesUnderScaledParent()
        {
            ...
            finally { if (output) Object.DestroyImmediate(output); Object.DestroyImmediate(parent); AssetDatabase.DeleteAsset(folder); }
        }
    }
}
