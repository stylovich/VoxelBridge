...
namespace DynamicGI.Rendering
{
    ...
    public sealed class DynamicGIShaderGlobals : MonoBehaviour
    {
        ...
        private static readonly int SurfaceVisibilityWeightFloorId = Shader.PropertyToID("_DynamicGI_SurfaceVisibilityWeightFloor");
        ...
        [Tooltip("Minimum visible interpolation weight used for normalization. Higher values prevent isolated probes from becoming full-energy blocks near walls; 0 preserves full renormalization.")]
        [SerializeField, Range(0f, 1f)] private float surfaceVisibilityWeightFloor = 0.5f;
        ...
        public float SurfaceVisibilityWeightFloor => surfaceVisibilityWeightFloor;
        ...
        public void Configure(
            ...
            float visibilityWeightFloor = 0.5f)
        {
            providerMode = mode;
            ...
            surfaceVisibilityWeightFloor = Mathf.Clamp01(visibilityWeightFloor);
        ...
        public void PublishNow()
        {
            ...
            Shader.SetGlobalFloat(SurfaceVisibilityWeightFloorId, surfaceVisibilityWeightFloor);
        ...
        private void OnDisable()
        {
            ...
            Shader.SetGlobalFloat(SurfaceVisibilityWeightFloorId, 0.5f);
        ...
        private void Sanitize()
        {
            ...
            surfaceVisibilityWeightFloor = Mathf.Clamp01(surfaceVisibilityWeightFloor);
